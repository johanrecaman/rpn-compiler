...
@ r0 = N
LDR r1, =history
@ r1 = base do historico
MOV r2, #2
@ r2 = indice da linha atual
SUB r2, r2, r0
@ r2 = line_idx - N
LSL r2, r2, #3
@ r2 = (line_idx - N) * 8
ADD r1, r1, r2
@ r1 = &history[line_idx - N]
VLDR d0, [r1]
VPUSH {d0}
...
@ restaura d0 na pilha VFP
VPUSH {d0}
@ aguarda KEY0 para avancar para a linha 13
LDR r4, =0xFF200050
wpress11:
  LDR r5, [r4]
  TST r5, #1
...
VMUL.F64 d0, d0, d1
VPUSH {d0}
@ salva resultado da linha 13 em history[12]
VPOP {d0}
LDR r1, =history
ADD r1, r1, #96
VSTR d0, [r1]
VPUSH {d0}
@ === exibir resultado linha 13 nos displays ===
@ peek: VPOP para usar, VPUSH para restaurar ao final
VPOP {d0}
@ converte float64 -> inteiro com sinal em r6
VCVT.S32.F64 s0, d0
